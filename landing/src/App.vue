  ...
  <div class="min-h-screen font-['Inter',sans-serif] bg-[#ECECEA]">
    ...
    <header class="bg-white">
      <div class="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-[40px] py-4 flex justify-between items-center">
        ...
        <a href="tel:+73952951966" class="inline-flex items-center justify-center gap-2.5 h-12 lg:h-9 rounded-3xl lg:rounded-[18px] px-6 lg:px-4 text-lg lg:text-base font-medium leading-[120%] cursor-pointer transition-colors duration-200 bg-white text-[#1E1E1E] hover:bg-[#1E1E1E] hover:text-white [&_svg_path]:fill-[#1E1E1E] hover:[&_svg_path]:fill-white">
          8 (3952) 951-966
        </a>
      </div>
    </header>
          ...
          <div class="grid md:grid-cols-2 gap-8 lg:gap-14 items-center">
            <div>
              <h1 class="text-[35px] lg:text-[56px] leading-[130%] font-bold text-white mb-6">
                Подготовка кухни к проверкам Роспотребнадзора <span class="text-yellow-300">без штрафов и остановки работы</span>
              </h1>
          ...
          <div class="grid md:grid-cols-2 gap-8 lg:gap-14 items-center">
            ...
            <div>
              ...
              <ul class="space-y-4 mb-8 text-[#1E1E1E] text-xl lg:text-2xl font-medium leading-[120%]">
                ...
                <li class="flex items-center gap-3">
                  <img src="/marker.svg" alt="Маркер">
                  Старший менеджер отдела продаж компании «ХИМЭКОЦЕНТР»
                </li>
              </ul>
              ...
              <div class="mb-8">
                ...
                <div class="grid grid-cols-2 gap-4 lg:gap-8">
                  <div class="bg-white rounded-3xl lg:rounded-[24px] p-4 cursor-pointer shadow-md hover:shadow-xl transition-shadow" @click="openCertificate('/cert-1.png')">
                    <div class="aspect-[3/4] bg-[#F4F4F4] rounded-3xl lg:rounded-[24px] flex items-center justify-center text-[#1E1E1E]">
                      <img src="/cert-1.png" alt="Сертификат 1">
                    </div>
                  </div>
                  <div class="bg-white rounded-3xl lg:rounded-[24px] p-4 cursor-pointer shadow-md hover:shadow-xl transition-shadow" @click="openCertificate('/cert-2.png')">
                    <div class="aspect-[3/4] bg-[#F4F4F4] rounded-3xl lg:rounded-[24px] flex items-center justify-center text-[#1E1E1E]">
                      <img src="/cert-2.png" alt="Сертификат 2">
                    </div>
                  </div>
                </div>
              </div>
